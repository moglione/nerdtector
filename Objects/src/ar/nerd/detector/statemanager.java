...
public static Object[]  _vvvv4(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
...
public static String  _vvvv5(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
...
_vvvv5(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
...
_vvvv5(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
...
_vvvv5(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
public static String  _vvvv6(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
anywheresoftware.b4a.objects.EditTextWrapper _edit = null;
anywheresoftware.b4a.objects.SpinnerWrapper _spinner1 = null;
anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _check = null;
...
_vvvv6(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
 }else if(_v.getObjectOrNull() instanceof android.widget.ScrollView) { 
...
_vvvv6(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
 }else if(_v.getObjectOrNull() instanceof android.view.ViewGroup) { 
...
_vvvv6(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
_v7 = BA.__b (new byte[] {32,42,-87,125,50,112,-26,40,34}, 832373);
 //BA.debugLineNum = 8;BA.debugLine="settingsFileName = \"settings.properties\"";
_v0 = BA.__b (new byte[] {32,59,84,53,62,48,13,114,120,57,8,37,33,61,19,41,58,59,83}, 559597);
...
_vvvv5(_ba,_activity.GetView(_i),_list1);
 }
};
...
_vvvv6(_ba,_activity.GetView(_i),_list1);
 }
};
