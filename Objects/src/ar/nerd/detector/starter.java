...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ar.nerd.detector", "ar.nerd.detector.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ar.nerd.detector.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
